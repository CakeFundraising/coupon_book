class AvatarPictureDecorator < ApplicationDecorator
  ...
  def uri(options={})
    if object.uri.present?
      ...
      options = {crop: :crop, width: object.avatar_crop_w, height: object.avatar_crop_h, x: object.avatar_crop_x, y: object.avatar_crop_y, transformation: :coupon_grid_sp, quality: :jpegmini, sign_url: true, class: classes}.merge options
