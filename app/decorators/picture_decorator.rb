class PictureDecorator < ApplicationDecorator
  ...
  def avatar(options={})
    if object.avatar.present?
      ...
      options = {crop: :crop, width: object.avatar_crop_w, height: object.avatar_crop_h, x: object.avatar_crop_x, y: object.avatar_crop_y, quality: :jpegmini, sign_url: true, class: classes}.merge options
  ...
  def banner(options={})
    if object.banner.present?
      classes = options.key?(:no_classes) ? '' : 'img-thumbnail img-responsive img-loaded'
      options = {crop: :crop, width: object.banner_crop_w, height: object.banner_crop_h, x: object.banner_crop_x, y: object.banner_crop_y, quality: :jpegmini, sign_url: true, class: classes}.merge options
  ...
  def qrcode(options={})
    if object.qrcode.present?
      classes = options.key?(:no_classes) ? '' : 'img-thumbnail img-responsive img-loaded'
      options = {crop: :crop, width: object.qrcode_crop_w, height: object.qrcode_crop_h, x: object.qrcode_crop_x, y: object.qrcode_crop_y, quality: :jpegmini, sign_url: true, class: classes}.merge options
  ...
  def avatar_path(options={})
    if object.avatar.present?
      options = {crop: :crop, width: object.avatar_crop_w, height: object.avatar_crop_h, x: object.avatar_crop_x, y: object.avatar_crop_y, quality: :jpegmini, sign_url: true}.merge options
  ...
  def banner_path(options={})
    if object.banner.present?
      options = {crop: :crop, width: object.banner_crop_w, height: object.banner_crop_h, x: object.banner_crop_x, y: object.banner_crop_y, quality: :jpegmini, sign_url: true}.merge options
