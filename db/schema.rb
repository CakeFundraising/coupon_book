...
ActiveRecord::Schema.define(version: 20151112150501) do
  ...
  add_index "consumers", ["origin_type", "origin_id"], name: "index_consumers_on_origin_type_and_origin_id", using: :btree
